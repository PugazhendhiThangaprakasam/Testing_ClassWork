...
public class AppTest 
{
    ...
    public void setUp() throws IOException
    {
        ...
        ExtentSparkReporter spark=new ExtentSparkReporter("D:\\Testing\\modelexam\\src\\report\\report.html");
    ...
    public void loginTest() throws InterruptedException, IOException
    {
        ...
        test1=extent.createTest("Test1","loginTest");
        if(popUp.equals("Login to AbhiBus"))
        {
            System.out.println("Login to AbhiBus is present");
            test1.log(Status.PASS, "Login to AbhiBus is present");
        }
        Thread.sleep(3000);
    ...
    public void testSearch() throws InterruptedException
    {
        ...
        test2=extent.createTest("Test2","TestSearch");
         ...
         {  
            ...
            test2.log(Status.PASS, "Mumbai and pune is present");
    ...
    public void testQuickLinks() throws InterruptedException, IOException
    {
        ...
        test3=extent.createTest("Test3","TestQuickLinks");
        if(name.equals("Media"))
        {
            System.out.println("Keyword Media is present");
            test2.log(Status.PASS, "Keyword Media is present");
        }
